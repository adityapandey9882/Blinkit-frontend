  ...
  return (
    <section>
        <div className='p-2 bg-white shadow-md flex items-center justify-between'>
            ...
            className='text-sm border border-primary-200 hover:bg-primary-200
                ...
                return(
                    <div className='w-32 h-56 rounded shadow-md' key={category._id}>
                        ...
                        <div className='flex items-center h-9 gap-2'>
                            ...
                            }} className='flex-1 bg-green-100 hover:bg-green-200 text-green-600 hover:text-green-700 font-medium py-1 rounded'>
                                Edit
                            </button>
                            <button onClick={()=>{
                                setOpenConfirmBoxDelete(true)
                                setDeleteCategory(category)
                            }} className='flex-1 bg-red-100 hover:bg-red-200 text-red-600 hover:text-red-700 font-medium py-1 rounded'>
                                Delete
                            </button>
                        </div>
                    </div>
